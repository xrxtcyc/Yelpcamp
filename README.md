...
9. app.js: 애플리케이션의 진입점 파일로, 서버를 설정하고 미들웨어 및 라우트를 구성하는 코드가 포함됩니다.
10.  middleware.js: 공통으로 사용되는 미들웨어 함수를 정의하는 파일입니다.
11. package.json: 프로젝트의 메타데이터 및 종속성 목록이 포함된 파일입니다. 프로젝트의 이름, 버전, 스크립트, 의존성 등이 여기에 정의됩니다.
12. schemas.js: 주로 데이터 검증을 위한 스키마 정의 파일일 가능성이 높습니다. 예를 들어, Joi 라이브러리를 사용하여 요청 데이터를 검증할 때 사용될 수 있습니다
